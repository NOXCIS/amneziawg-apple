...
func dialTLSWithFingerprint(ctx context.Context, network, addr, serverName string, secure bool, clientHelloID tls.ClientHelloID, logger CLogger) (net.Conn, error) {
